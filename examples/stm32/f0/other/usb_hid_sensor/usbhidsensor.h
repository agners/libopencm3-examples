#ifndef USBHIDSENSOR_H
#define USBHIDSENSOR_H

/*
 * From https://www.usb.org/sites/default/files/hutrr39b_0.pdf
 * Formatted using:
 * clang-format --style="{ColumnLimit: 0, AlignConsecutiveMacros: true}"
 */
...
//NOTE: the usage tables actually define these as two bytes, but in orderi
...
#define HID_USAGE_SENSOR_DATA_MOD_VENDOR_RESERVED              0xF0             // US //state usages
#define HID_USAGE_SENSOR_STATE                                 0x0A, 0x01, 0x02 //          NAry          //state selectors
...
#define HID_USAGE_SENSOR_STATE_ERROR                           0x0A, 0x06, 0x08 //          Sel          //event usages
#define HID_USAGE_SENSOR_EVENT                                 0x0A, 0x02, 0x02 //          NAry          //event selectors
...
#define HID_USAGE_SENSOR_DATA_LOCATION_POSTAL_CODE                      0x0A, 0x27, 0x04 //property usages (get/set feature report)
...
#define HID_USAGE_SENSOR_DATA_ENVIRONMENTAL_WIND_SPEED             0x0A, 0x36, 0x04 //property usages (get/set feature report)
...
#define HID_USAGE_SENSOR_DATA_MECHANICAL_WEIGHT                      0x0A, 0x98, 0x04 //property usages (get/set feature report)
...
#define HID_USAGE_SENSOR_DATA_LIGHT_CONSUMER_IR_SENTENCE_RECEIVE  0x0A, 0xD6, 0x04 //property usages (get/set feature report)
...
#define HID_USAGE_SENSOR_DATA_SCANNER_NFC_SENTENCE_RECEIVE  0x0A, 0xF2, 0x04 //property usages (get/set feature report)
...
#define HID_USAGE_SENSOR_DATA_TIME_JULIAN_DAY_OF_YEAR                 0x0A, 0x2A, 0x05 //property usages (get/set feature report)
...
#define Data_Var_Rel                   0x06 //collection flags
#define Physical                       0x00
#define Application                    0x01
#define Logical                        0x02
#define NamedArray                     0x04
#define UsageSwitch                    0x05 //other
